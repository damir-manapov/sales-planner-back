...
ALTER TABLE user_roles ADD COLUMN IF NOT EXISTS shop_id INTEGER REFERENCES shops(id) ON DELETE CASCADE;
...
CREATE INDEX IF NOT EXISTS idx_user_roles_user_shop ON user_roles(user_id, shop_id);
